# Support for Output Descriptors in Baldeaglecoin Core

Since Baldeaglecoin Core v0.17, there is support for Output Descriptors. This is a
...
- Segwit addresses (bech32, of the form `bec1...` for mainnet or `tbec1...` for testnet, defined in [BIP 173](https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki)).
...
on Baldeaglecoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Baldeaglecoin Core wallets, a convenience function `combo` is
