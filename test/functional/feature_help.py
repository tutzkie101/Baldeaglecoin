...
"""Verify that starting baldeaglecoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start baldeaglecoin with -h for help text")
        ...
        self.log.info("Start baldeaglecoin with -version for version information")
        ...
        self.log.info("Start baldeaglecoind with -fakearg to make sure it does not start")
