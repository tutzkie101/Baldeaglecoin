...
{
    const char* pszTimestamp = "Bald Eagle Coins is created on august 2021";
    const CScript genesisOutputScript = CScript() << ParseHex("2104080945a689ad5023690c80f3a49c8f13f8d45b8c857fbcbc8bc4a8e4d3eb4b10f4d4604fa08dce601aaf0f470216fe1b51850b4acf21b179c45070ac7b03a9") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        consensus.BIP16Height = 32256; // 87afb798a3ad9378fcd56123c81fb31cfd9a8df4719b9774d71730c16315a092 - October 1, 2012
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x381fe225f853921c497542438af7b7be8440c1d96e632ffbf2a17d75f202c5a7"));
        assert(genesis.hashMerkleRoot == uint256S("0x2db7e7ade3f46b44e968eaf1a985380b99360e99fad6863abf0e774cef49cd68"));
...
public:
    CTestNetParams() {
        ...
        checkpointData = {
            {
                {0, uint256S("0x3852665a33764fa378169a95c02bf94e3730ea0a9f04976cde2b1784e19028bc")},
            }
        };
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        checkpointData = {
            {
                {0, uint256S("0xdd44810835315393c2d28497ece4962c5fade2d7eae0c943fc4380e1d43b8312")},
            }
        };
