...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " baldeaglecoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  baldeaglecoin-tx [options] <hex-tx> [commands]  Update hex-encoded baldeaglecoin transaction\n" +
            "or:     baldeaglecoin-tx [options] -create [commands]   Create hex-encoded baldeaglecoin transaction\n" +
            "\n";
