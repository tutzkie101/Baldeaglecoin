...
bech32_templates = [
  ...
  ('bec',   0, 20, (False, 'main',    None, True), p2wpkh_prefix),
  ('bec',   0, 32, (False, 'main',    None, True), p2wsh_prefix),
  ('bec',   1,  2, (False, 'main',    None, True), (OP_1, 2)),
  ('tbec',  0, 20, (False, 'test',    None, True), p2wpkh_prefix),
  ('tbec',  0, 32, (False, 'test',    None, True), p2wsh_prefix),
  ('tbec',  2, 16, (False, 'test',    None, True), (OP_2, 16)),
  ('rbec',  0, 20, (False, 'regtest', None, True), p2wpkh_prefix),
  ('rbec',  0, 32, (False, 'regtest', None, True), p2wsh_prefix),
  ('rbec', 16, 40, (False, 'regtest', None, True), (OP_16, 40))
]
# templates for invalid bech32 sequences
bech32_ng_templates = [
  # hrp, version, witprog_size, invalid_bech32, invalid_checksum, invalid_char
  ('tc',    0, 20, False, False, False),
  ('tbec',  17, 32, False, False, False),
  ('rbec',  3,  1, False, False, False),
  ('bec',   15, 41, False, False, False),
  ('tbec',  0, 16, False, False, False),
  ('rbec',  0, 32, True,  False, False),
  ('bec',   0, 16, True,  False, False),
  ('tbec',  0, 32, False, True,  False),
  ('rbec',  0, 20, False, False, True)
]
